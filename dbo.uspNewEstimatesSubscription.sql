...
/****** Object:  StoredProcedure [dbo].[uspNewEstimatesSubscription]    Script Date: 1/31/2025 12:19:23 PM ******/
SET ANSI_NULLS ON
GO
...
EXEC	[dbo].[uspNewEstimatesSubscription]
		@sales_code = N'LaPaRM',
		@site = N'*',
		@product_code = N'*',
...
********************************************************************
*/
CREATE PROCEDURE [dbo].[uspNewEstimatesSubscription]
...
DECLARE @report_name NVARCHAR(40) = 'SNAP-SHOT New Estimates';
DECLARE @report_file_name NVARCHAR(50) = CONCAT(@fileprefix,'_NewEstimates.xlsx');
DECLARE @report_id uniqueidentifier;		--E81036F5-E973-49E2-B98A-1D03ADB06EC5
DECLARE @subscription_id uniqueidentifier;	--1BF01905-4511-4582-B4F2-DBF5C1364ABC
...
--'|SalesManager|,AMR_NE,|SalesChannel|,Regional_SC,|Site|,*,|Salesman|,OsbornCE,|ProductCode|,*,|TimeframeText|,CW'

...
/****** Object:  StoredProcedure [dbo].[uspNewShipmentsSubscription]    Script Date: 1/31/2025 12:20:40 PM ******/
SET ANSI_NULLS ON
GO
...
EXEC	[dbo].[uspNewShipmentsSubscription]
		@sales_code = N'LaPaRM',
		@site = N'*',
		@product_code = N'*',
...
********************************************************************
*/
CREATE PROCEDURE [dbo].[uspNewShipmentsSubscription]
    @sales_code nvarchar(8),						--[Territory], |Salesman|
	@site nvarchar(12) = N'*',
	@product_code nvarchar(8) = N'*',
...
DECLARE @report_name NVARCHAR(40) = 'SNAP-SHOT Shipments';
DECLARE @report_file_name NVARCHAR(50) = CONCAT(@fileprefix,'_Shipments.xlsx');
DECLARE @report_id uniqueidentifier;		--77F162F8-064B-4DD3-B79E-3EFE5B13C062
DECLARE @subscription_id uniqueidentifier;	--3C70A6EA-C725-4B97-8111-774B0902B69A
...
SET @paramstring = CONCAT('|SalesManager|,',@Region,',|SalesChannel|,',@SalesChannel,',|Sites|,',@site,',|Salesman|,',@sales_code,',|ProductCode|,',@product_code,',|TimeframeText|,',@timeframe)
--Sample

--'|SalesManager|,*,|SalesChannel|,Regional_SC,|Sites|,*,|Salesman|,Recht,|ProductCode|,*,|TimeframeText|,CW'
--'|SalesManager|,*,|SalesChannel|,Regional_SC,|Sites|,*,|Salesman|,LaPaRM,|ProductCode|,*,|TimeframeText|,CW'
